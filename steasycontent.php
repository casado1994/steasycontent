...
class StEasyContent extends Module implements WidgetInterface
{
    ...
    public static $admin_tab_save_locked = false;
    public static $location = array(
        ...
        128 => array('id' =>128 , 'name' => 'Breadcrumb'  , 'hook' => 'Breadcrumb', 'stretched' => 1, 'full_width' => 1),
        129 => array('id' =>129 , 'name' => 'displayWrapperTop'  , 'hook' => 'WrapperTop', 'stretched' => 1, 'full_width' => 1),
        130 => array('id' =>130 , 'name' => 'displayBeforePrice'  , 'hook' => 'BeforePrice', 'stretched' => 1, 'full_width' => 1),
    );
    // key: type+00
    public static $location_extra = array(
        ...
        '2300' => array('hook' => 'FullWidthCategoryHeader'),
        '2500' => array('hook' => 'FullWidthCategoryFooter'),
        '2600' => array('hook' => 'ProductDescRightColumn'),
        '2700' => array('hook' => 'ProductLeftColumn'),
        '2800' => array('hook' => 'ProductPriceRight'),
	...
	function __construct()
	{
		...
		$this->description = $this->getTranslator()->trans('This module is used to create tabs, accordions, FAQ, parallax block, products sliders, lists, textbox sliders, testimonals and more.', array(), 'Modules.Steasycontent.Admin');
        ...
        self::$text_width = array(
            array('id' => 90, 'name'=> $this->getTranslator()->trans('Left', array(), 'Admin.Theme.Panda').' 90%'),
            array('id' => 91, 'name'=> $this->getTranslator()->trans('Center', array(), 'Admin.Theme.Panda').' 90%'),
            array('id' => 92, 'name'=> $this->getTranslator()->trans('Right', array(), 'Admin.Theme.Panda').' 90%'),
            array('id' => 80, 'name'=> $this->getTranslator()->trans('Left', array(), 'Admin.Theme.Panda').' 80%'),
            array('id' => 81, 'name'=> $this->getTranslator()->trans('Center', array(), 'Admin.Theme.Panda').' 80%'),
            array('id' => 82, 'name'=> $this->getTranslator()->trans('Right', array(), 'Admin.Theme.Panda').' 80%'),
            array('id' => 70, 'name'=> $this->getTranslator()->trans('Left', array(), 'Admin.Theme.Panda').' 70%'),
            array('id' => 71, 'name'=> $this->getTranslator()->trans('Center', array(), 'Admin.Theme.Panda').' 70%'),
            array('id' => 72, 'name'=> $this->getTranslator()->trans('Right', array(), 'Admin.Theme.Panda').' 70%'),
            array('id' => 60, 'name'=> $this->getTranslator()->trans('Left', array(), 'Admin.Theme.Panda').' 60%'),
            array('id' => 61, 'name'=> $this->getTranslator()->trans('Center', array(), 'Admin.Theme.Panda').' 60%'),
            array('id' => 62, 'name'=> $this->getTranslator()->trans('Right', array(), 'Admin.Theme.Panda').' 60%'),
            array('id' => 50, 'name'=> $this->getTranslator()->trans('Left', array(), 'Admin.Theme.Panda').' 50%'),
            array('id' => 51, 'name'=> $this->getTranslator()->trans('Center', array(), 'Admin.Theme.Panda').' 50%'),
            array('id' => 52, 'name'=> $this->getTranslator()->trans('Right', array(), 'Admin.Theme.Panda').' 50%'),
            array('id' => 30, 'name'=> $this->getTranslator()->trans('Left', array(), 'Admin.Theme.Panda').' 30%'),
            array('id' => 31, 'name'=> $this->getTranslator()->trans('Center', array(), 'Admin.Theme.Panda').' 30%'),
            array('id' => 32, 'name'=> $this->getTranslator()->trans('Right', array(), 'Admin.Theme.Panda').' 30%'),
            array('id' => 20, 'name'=> $this->getTranslator()->trans('Left', array(), 'Admin.Theme.Panda').' 20%'),
            array('id' => 21, 'name'=> $this->getTranslator()->trans('Center', array(), 'Admin.Theme.Panda').' 20%'),
            array('id' => 22, 'name'=> $this->getTranslator()->trans('Right', array(), 'Admin.Theme.Panda').' 20%'),
            array('id' => 10, 'name'=> $this->getTranslator()->trans('Left', array(), 'Admin.Theme.Panda').' 10%'),
            array('id' => 11, 'name'=> $this->getTranslator()->trans('Center', array(), 'Admin.Theme.Panda').' 10%'),
            array('id' => 12, 'name'=> $this->getTranslator()->trans('Right', array(), 'Admin.Theme.Panda').' 10%'),
        );
        ...
        self::$type = array(
            ...
            23 => array('value' => 23, 'id' => 'type_23', 'label' => $this->getTranslator()->trans('Full width category page header', array(), 'Modules.Steasycontent.Admin')),
            25 => array('value' => 25, 'id' => 'type_25', 'label' => $this->getTranslator()->trans('Full width category page footer', array(), 'Modules.Steasycontent.Admin')),
            27 => array('value' => 27, 'id' => 'type_27', 'label' => $this->getTranslator()->trans('Product left column', array(), 'Modules.Steasycontent.Admin')),
            28 => array('value' => 28, 'id' => 'type_28', 'label' => $this->getTranslator()->trans('Right side of product price', array(), 'Modules.Steasycontent.Admin')),
            ...
            11 => array('value' => 11, 'id' => 'type_11', 'label' => $this->getTranslator()->trans('Product middle', array(), 'Modules.Steasycontent.Admin')),
            26 => array('value' => 26, 'id' => 'type_26', 'label' => $this->getTranslator()->trans('Right side of product description', array(), 'Modules.Steasycontent.Admin')),
        ...
        if($this->stblog_status)
        {
            ...
            unset(self::$type[20],self::$type[21]);
        }
        $this->vc_hooks = array(
            $this->getTranslator()->trans('Full width block', array(), 'Admin.Theme.Panda') => 'displayFullWidthTop',
            $this->getTranslator()->trans('Block', array(), 'Admin.Theme.Panda') => 'displayHome',
            $this->getTranslator()->trans('Column block', array(), 'Admin.Theme.Panda') => 'displayLeftColumn',
            $this->getTranslator()->trans('Footer block', array(), 'Admin.Theme.Panda') => 'displayStackedFooter1',
        );
	...
	function install()
	{
		$res = parent::install() &&
            ...
            $this->registerHook('displayProductPriceRight') &&
	...
	public function installDB()
	{
		$return = (bool)Db::getInstance()->execute('
			CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'st_easy_content` (
                ...
                `id_product` varchar(4096) DEFAULT NULL,
                ...
                `bo_tab` tinyint(1) unsigned NOT NULL DEFAULT 0,
        ...
        $return &= Db::getInstance()->execute('
            CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'st_easy_content_column` (
                `id_st_easy_content_column` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
        ...
        $return &= Db::getInstance()->execute('
            CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'st_easy_content_element` (
                `id_st_easy_content_element` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
	...
	public function getContent()
	{
        ...
        if ($id_st_easy_content) {
            ...
            switch((int)Tools::getValue('type')) {
                ...
                case 27:
                case 28:
                    $easy_content->id_product = ''; // Clear by default
        if ($filter = Tools::getValue('id_category_brand')) {
            list($in, $id) = explode('_', $filter);
            if ($in > 0 && $id > 0) {
                if ($in == 1) { // Specific products
                    if ($ids = Tools::getValue('st_id_product')) {
                        $easy_content->id_product = ',' . implode(',', $ids) . ',';
                    } else {
                        $easy_content->id_product = '';
                    }
                } elseif ($in == 2) { // Category
                    $easy_content->id_category = (int)$id;
                } elseif ($in == 3) { // Manufacturer
                    $easy_content->id_manufacturer = (int)$id;
                }
            }
        }
    break;
			...
			if (!count($error) && $easy_content->validateFields(false) && $easy_content->validateFieldsLang(false))
            {
                ...
                if($easy_content->save())
                {
                    ...
                    if(isset($_POST['savesteasycontentAndStay']))
                        ...
                        $this->_html .= $this->displayConfirmation($this->getTranslator()->trans('Custom content', array(), 'Admin.Theme.Panda').' '.($id_st_easy_content ? $this->getTranslator()->trans('updated', array(), 'Admin.Theme.Panda') : $this->getTranslator()->trans('added', array(), 'Admin.Theme.Panda')));
                }
                else {
                    $easy_content->restoreShopIds($shop_ids);
                    $this->_html .= $this->displayError($this->getTranslator()->trans('An error occurred during custom content', array(), 'Admin.Theme.Panda').' '.($id_st_easy_content ? $this->getTranslator()->trans('updating', array(), 'Admin.Theme.Panda') : $this->getTranslator()->trans('creation', array(), 'Admin.Theme.Panda')));
                }    
            }
			else
        ...
        if (isset($_POST['savesteasycontentrow']) || isset($_POST['savesteasycontentrowAndStay']))
		{
			...
			if (!count($error) && $column->validateFields(false))
            {
                if($column->save())
                {
                    ...
                    $this->_html .= $this->displayError($this->getTranslator()->trans('An error occurred during column', array(), 'Admin.Theme.Panda').' '.($id_st_banner_group ? $this->getTranslator()->trans('updating', array(), 'Admin.Theme.Panda') : $this->getTranslator()->trans('creation', array(), 'Admin.Theme.Panda')));
            }
            else
                $this->_html .= count($error) ? implode('',$error) : $this->displayError($this->getTranslator()->trans('Invalid value for field(s).', array(), 'Admin.Theme.Panda'));
            $this->clearEasyContentCache();
        ...
        if (isset($_POST['savesteasycontentelement']) || isset($_POST['savesteasycontentelementAndStay']))
        {
			...
			if (!count($error) && $element->validateFields(false))
            {
                if($element->save())
                {
                    ...
                    $this->_html .= $this->displayError($this->getTranslator()->trans('An error occurred during element', array(), 'Admin.Theme.Panda').' '.($id_st_banner_group ? $this->getTranslator()->trans('updating', array(), 'Admin.Theme.Panda') : $this->getTranslator()->trans('creation', array(), 'Admin.Theme.Panda')));
            }
            else
                $this->_html .= count($error) ? implode('',$error) : $this->displayError($this->getTranslator()->trans('Invalid value for field(s).', array(), 'Admin.Theme.Panda'));
        }
    ...
    'desc' => '<script type="text/javascript">
        $(document).ready(function(){
            $("input[name=\'type\']").on("change", function(){
                var type = $(this).val();
                var $category_brand = $("#id_category_brand").closest(".form-group");
                var $products = $("#ac_products").closest(".form-group");
                var $category = $("#id_category").closest(".form-group");
                var $manufacturer = $("#id_manufacturer").closest(".form-group");
                if ([6,7,8,9,10,11,26,27,28].indexOf(parseInt(type)) !== -1) {
                    $category_brand.show();
                    $products.show();
                    $category.show();
                    $manufacturer.show();
				...
				array(
					'type' => 'text',
					'label' => $this->getTranslator()->trans('Link:', array(), 'Admin.Theme.Panda'),
					'name' => 'url',
					'lang' => true,
					'size' => 64,
				),
                ...
                array(
                    'type' => 'select',
                    'label' => $this->getTranslator()->trans('Google fonts:', array(), 'Admin.Theme.Panda'),
                ...
                'font_text'=>array(
                    'type' => 'select',
                    'label' => $this->getTranslator()->trans('Font weight:', array(), 'Admin.Theme.Panda'),
                    ...
                    'desc' => '<p>'.$this->getTranslator()->trans('Once a font has been added, you can use it everywhere without adding it again.', array(), 'Modules.Steasycontent.Admin').'</p><a id="add_google_font" class="btn btn-default btn-block fixed-width-md" href="javascript:;">Add</a><br/><p id="google_font_example" class="fontshow">Example Title</p><ul id="curr_google_font_name">'.$google_font_name_html.'</ul>'.$google_font_link,
                ),
                array(
                    'type' => 'hidden',
                ...
                array(
					...
					'values' => array(
                        ...
                        array(
                            'id' => 'hide_on_mobile_4',
                            'value' => 4,
                            'label' => $this->getTranslator()->trans('Open (screen width < 992px)', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'hide_on_mobile_1',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Hide on small screen devices (screen width < 992px)', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'hide_on_mobile_3',
                            'value' => 3,
                            'label' => $this->getTranslator()->trans('Hide on small screen devices (screen width < 768px)', array(), 'Admin.Theme.Panda')),
                        array(
							'id' => 'hide_on_mobile_2',
							'value' => 2,
        ...
        $this->fields_form[1]['form'] = array(
            ...
            'input' => array(
                array(
                 ...
                 array(
                    'type' => 'color',
                    'label' => $this->getTranslator()->trans('Title color:', array(), 'Admin.Theme.Panda'),
                    'name' => 'title_color',
                    'class' => 'color',
                    'size' => 20,
                    'validation' => 'isColor',
                ...
                array(
                    ...
                    'values' => array(
                        array(
                            'id' => 'title_align_left',
                            'value' => 0,
                            'label' => $this->getTranslator()->trans('Align left', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'title_align_center',
                            'value' => 1,
                            'label' => $this->getTranslator()->trans('Align center', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'title_align_right',
                            'value' => 2,
                            'label' => $this->getTranslator()->trans('Align right', array(), 'Admin.Theme.Panda')),
                        array(
                            'id' => 'title_align_none',
                            'value' => 3,
        ...
        $this->fields_form[2]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Parallax background image', array(), 'Modules.Steasycontent.Admin'),
                'icon' => 'icon-cogs'                
            ),
        ...
        $this->fields_form[3]['form'] = array(
            'legend' => array(
                'title' => $this->getTranslator()->trans('Video background', array(), 'Admin.Theme.Panda'),
                'icon' => 'icon-cogs'                
            ),
            'description' => $this->getTranslator()->trans('Video background feature can not work on both Android and IOS devices, which is due to restrictions on autoplay and performance, so you also need to upload a video thumbnail, the thumbnail will be displayed on mobile devices.', array(), 'Admin.Theme.Panda'),
            'input' => array(
        ...
        $this->fields_form[0]['form']['input'][] = $this->fields_form[1]['form']['input'][] = array(
            ...
            'id' => 'a_cancel',
			'label' => '',
			'name' => '<a class="btn btn-default btn-block fixed-width-md" href="'.AdminController::$currentIndex.'&configure='.$this->name.'&token='.Tools::getAdminTokenLite('AdminModules').'"><i class="icon-arrow-left"></i> '.$this->getTranslator()->trans('Back to list', array(), 'Admin.Theme.Panda').'</a>',                  
		);
        ...
        if($easy_content->id)
        {
            ...
            if ($easy_content->bg_img)
            {
                ...
                $this->fields_form[2]['form']['input']['bg_img_field']['desc'][] = '<span class="image_thumb_block"><img src="'.($image_url).'" /><a class="btn btn-default st_delete_image" href="javascript:;" data-s_id="'.(int)$easy_content->id.'" data-s_k="bg_img"><i class="icon-trash"></i> '.$this->getTranslator()->trans('Delete', array(), 'Admin.Theme.Panda').'</a></span>';
            }
            if ($easy_content->video_poster)
            {
                $image_url = $this->name.'/'.$easy_content->video_poster;
                $this->fetchMediaServer($image_url);
                $this->fields_form[3]['form']['input']['video_poster_field']['desc'][] = '<span class="image_thumb_block"><img src="'.($image_url).'" /><a class="btn btn-default st_delete_image" href="javascript:;" data-s_id="'.(int)$easy_content->id.'" data-s_k="video_poster"><i class="icon-trash"></i> '.$this->getTranslator()->trans('Delete', array(), 'Admin.Theme.Panda').'</a></span>';
            }
        ...
        $this->fields_form[0]['form']['input']['products']['desc'] = $this->getTranslator()->trans('Type product name to add prodcuts:', array(), 'Modules.Steasycontent.Admin').'<br/>'.$this->getTranslator()->trans('Current products', array(), 'Admin.Theme.Panda')
        ...
        if ($easy_content->id) {
            if (in_array($easy_content->type, array(6,7,8,9,10,11,26,27,28))) {
    ...
    public function createLinks()
    {
        ...
        $links = array(
            array('name'=>$this->getTranslator()->trans('Product', array(), 'Admin.Theme.Panda'),'query'=>$product_arr),
    ...
    {
        return StBlogClass::getCategoryBlogs($id_st_blog_category, '', $id_lang, $id_shop,false, false);
    }
    ...
    public static function displayType($value, $tr)
    {
        if (key_exists($value, self::$type)) {
            ...
            $result = Context::getContext()->getTranslator()->trans('--', array(), 'Admin.Theme.Panda');    
        }
        return $result;
    }
        ...
        switch((int)$tr['type']) {
            ...
            case 3:
                ...
                if ($cms->id) {
                    ...
                    $result = $context->getTranslator()->trans('All', array(), 'Admin.Theme.Panda');
                }
                break;
            case 4:
            case 5:
	...
	{	    
        ...
        return $this->getTranslator()->trans('--', array(), 'Admin.Theme.Panda');
	}
    protected function initList()
    {
        $this->fields_list = array(
            ...
            'type' => array(
                'title' => $this->getTranslator()->trans('Type', array(), 'Admin.Theme.Panda'),
                'width' => 140,
                'type' => 'text',
            ...
            'location' => array(
                'title' => $this->getTranslator()->trans('Name / Show on', array(), 'Admin.Theme.Panda'),
                'width' => 140,
                'type' => 'text',
        ...
        $helper->listTotal = StEasyContentClass::getListContent(0, 0, 0, true);
        $helper->identifier = 'id_st_easy_content';
        ...
        $helper->bulk_actions['delete'] = array(
            'text'=>$this->getTranslator()->trans('Delete', array(), 'Admin.Theme.Panda'),
    ...
    {       
        ...
        $result .= '<li><span>'.$steasycontent->getTranslator()->trans('Type', array(), 'Admin.Theme.Panda').'</span>'.$steasycontent->_elements[$value]['name'].'</li>';
    ...
    protected function initColumnList($id_parent = 0, $query_string = '', $row=array())
    {
        ...
        $this->fields_list = array(
            ...
            'name' => array(
                'title' => $this->getTranslator()->trans('Name', array(), 'Admin.Theme.Panda'),
                'width' => 200,
                'type' => 'text',
                'search' => false,
                'orderby' => false
            ...
            'width' => array(
                'title' => $this->getTranslator()->trans('Width', array(), 'Admin.Theme.Panda'),
                'width' => 200,
                'type' => 'text',
        ...
        if ($id_parent) {
            ...
            if ($row['active']) {
                $link_status = '<a class="action-enabled" title="'.$this->getTranslator()->trans('Enabled', array(), 'Modules.Steasycontent.Admin').'" href="'.AdminController::$currentIndex.'&configure='.$this->name.'&status'.$this->name.'column&id_st_easy_content_column='.
        ...
        $helper->title = '';
        $helper->listTotal = (isset($row['name']) && $row['name'] ? $row['name'] : $this->getTranslator()->trans('Column list', array(), 'Modules.Steasycontent.Admin')).($link_status ? '['.$link_status.']' : '');
    ...
    private function _prepareHook($identify, $type=1, $vc=null)
    {
        ...
        foreach ($easy_content as $key => &$value) {
            ...
            $value['is_full_width'] = isset(self::$location[$value['location']]['full_width']) || $value['type']==3 || $value['id_st_blog'] || $type==23 || $type==25;//the same code in displayHeader function
        ...
        if (!$this->isCached($this->templatePath.'header.tpl', $this->getCacheId()))
        {
            ...
            if (is_array($custom_css_arr) && count($custom_css_arr)) {
                ...
                foreach ($custom_css_arr as $v) {
                    $classname = isset(self::$location[$v['location']]['full_width']) || $v['type']==3 || $v['id_st_blog'] || $v['type']==23 || $v['type']==25 ? '#easycontent_container_'.$v['id_st_easy_content'].' ' : '#easycontent_'.$v['id_st_easy_content'].' ';
    ...
    public function hookDisplayProductPriceRight($params)
{
    if (!$this->isCached('steasycontent.tpl', $this->getCacheId('steasycontent'))) {
        $id_product = (int)Tools::getValue('id_product');
        $content = StEasyContentClass::getContentForHook('ProductPriceRight', $id_product);
    ...
    return $this->display(__FILE__, 'steasycontent.tpl', $this->getCacheId('steasycontent'));
}
public static function getContentForHook($hook, $id_product = null)
{
    $sql = 'SELECT * FROM ' . _DB_PREFIX_ . 'st_easy_content
            WHERE active = 1 AND location = (SELECT id FROM ' . _DB_PREFIX_ . 'hook WHERE name = "' . pSQL($hook) . '")';

    if ($id_product) {
        $sql .= ' AND (id_product LIKE "%,' . (int)$id_product . ',%" OR id_product IS NULL OR id_product = "")';
    }
    ...
    public function hookDisplayMiddleProduct($params)
    {
        ...
        $cache_id = '11-'.$id_product;
        if (!$this->isCached($this->templatePath.'steasycontent.tpl', $this->stGetCacheId($cache_id)))
            $this->_prepareHook(0,11);
        return $this->fetch($this->templatePath.'steasycontent.tpl', $this->stGetCacheId($cache_id));
    }
    ...
    public function hookDisplayFullWidthCategoryHeader($params)
    {
        $id_category = Tools::getValue('id_category');
        if (!$id_category) {
            return false;
        }
        $cache_id = '23-'.$id_category;
        if (!$this->isCached($this->templatePath.'steasycontent.tpl', $this->stGetCacheId($cache_id)))
            $this->_prepareHook(0,23);
        return $this->fetch($this->templatePath.'steasycontent.tpl', $this->stGetCacheId($cache_id));
    }
    public function hookDisplayFullWidthCategoryFooter($params)
    {
        $id_category = Tools::getValue('id_category');
        if (!$id_category) {
            return false;
        }
        $cache_id = '25-'.$id_category;
        if (!$this->isCached($this->templatePath.'steasycontent.tpl', $this->stGetCacheId($cache_id)))
            $this->_prepareHook(0,25);
        return $this->fetch($this->templatePath.'steasycontent.tpl', $this->stGetCacheId($cache_id));
    }
    ...
    public function hookDisplayProductDescRightColumn($params)
    {
        ...
        $cache_id = '26-'.$id_product;
        if (!$this->isCached($this->templatePath.'steasycontent.tpl', $this->stGetCacheId($cache_id)))
            $this->_prepareHook(0,26);
        return $this->fetch($this->templatePath.'steasycontent.tpl', $this->stGetCacheId($cache_id));
    }
    ...
    public function hookDisplayCMSDisputeInformation($params){        
        return $this->hookDisplayCMSExtra($params);
    }
    ...
    public function hookDisplayAdminProductsExtra($params)
    {
        ...
        $tabs = array();
        $result = StEasyContentClass::getTabForAdminProduct($id_product);
        $id_st_easy_content = 0;
        foreach($result as $row) {
            if (!$id_st_easy_content) {
                $id_st_easy_content = $row['id_st_easy_content'];
            }
            if ($id_st_easy_content && $id_st_easy_content != $row['id_st_easy_content']) {
                continue;
            }
            $tabs['title'][$row['id_lang']] = $row['title'];
            $tabs['text'][$row['id_lang']] = $row['text'];
        }
        $this->smarty->assign(array(
            'default_lang' => (int)Configuration::get('PS_LANG_DEFAULT'),
            'languages' => Language::getLanguages(false),
            'id_product' => $id_product,
            'ec_module_url' =>AdminController::$currentIndex.'&configure='.$this->name.'&token='.Tools::getAdminTokenLite('AdminModules'),
            'ec_tabs' => $tabs,
            'id_st_easy_content' => $id_st_easy_content,
        ));
        return $this->display(__FILE__, 'views/templates/admin/steasycontent.tpl'); 
    }
    public function hookActionProductSave($params)
    {
        ...
        if (self::$admin_tab_save_locked) {
            return false;
        }
        if (Tools::getvalue('ec_act') == 'save_ec_tab') {
            $data = array();
            $id_st_easy_content = (int)Tools::getValue('id_st_easy_content');
            $easy_content = new StEasyContentClass($id_st_easy_content);
            $easy_content->type = 9;
            $easy_content->active = 1;
            $easy_content->bo_tab = 1;
            $easy_content->id_product = ','.$id_product.',';
            foreach($_POST as $k => $v) {
                if (strpos($k, 'ec_title_') !== false) {
                    $easy_content->title[str_replace('ec_title_', '', $k)] = $v;
                }
                if (strpos($k, 'ec_text_') !== false) {
                    $easy_content->text[str_replace('ec_text_', '', $k)] = $v;
                }
            }
            $has_data = false;
            foreach($easy_content->title as $val) {
                if (trim($val)) {
                    $has_data = true;
                    break;
                }
            ...
            $result = StEasyContentClass::getTabForAdminProduct($id_product);
            $id_st_easy_content_array = array();
            foreach($result as $row) {
                $id_st_easy_content_array[$row['id_st_easy_content']] = $row['id_st_easy_content'];
            }
            foreach($id_st_easy_content_array as $id) {
                $tmp = new StEasyContentClass($id);
                $tmp->delete();
            }
            if ($has_data) {
                $easy_content->id = 0;
                $easy_content->id_st_easy_content = 0;
                $easy_content->save();    
            }
            
            self::$admin_tab_save_locked = true;
        }
    }
    ...
    function vc_map_init()
    {
        ...
        $default = 0;
        // Avoid pagination
        $_GET['steasycontent_pagination'] = 1000;
        foreach(StEasyContentClass::getListContent(0, 1, 1) AS $tr) {
            $key = $this->getTranslator()->trans('ID:', array(), 'Admin.Theme.Panda').$tr['id_st_easy_content'];
            if($tr['title'])
                $key .= '|'.$tr['title'];
            elseif($tr['text'])
                $key .= '|'.Tools::truncateString(strip_tags(stripslashes($tr['text'])), 50);
            else{
                $top_columns = StEasyContentColumnClass::getSub(0, 0, $tr['id_st_easy_content']);
                $elements = array();
                if ($top_columns) {
        ...
        $params = array(
            ...
            'params' => array(
                ...
                array(
                    ...
                    'code' => '<a href="'.$this->context->link->getAdminLink('AdminModules', false).'&configure='.$this->name.'&module_name='.$this->name.'&token='.Tools::getAdminTokenLite('AdminModules').'" target="_blank" class="st_conf_link">'.$this->getTranslator()->trans('Go to the configuration page of this module to change settings.', array(), 'Admin.Theme.Panda').'</a>',
                ),
                array(
                    'type' => 'html',
    ...
    /*public function hookActionStAssemble($product){
        $cates = Product::getProductCategories($product['id_product']);
        $result = Db::getInstance()->getRow('
            SELECT sec.*, secl.*
            FROM `'._DB_PREFIX_.'st_easy_content` sec
            INNER JOIN `'._DB_PREFIX_.'st_easy_content_shop` st_easy_content_shop ON (st_easy_content_shop.`id_st_easy_content` = sec.`id_st_easy_content` AND st_easy_content_shop.`id_shop` = '.Context::getContext()->shop->id.')
            LEFT JOIN `'._DB_PREFIX_.'st_easy_content_lang` secl ON (sec.`id_st_easy_content` = secl.`id_st_easy_content`)
            WHERE sec.`type` = 9 AND (sec.`id_product` LIKE "%,'.$product['id_product'].',%" || sec.`id_category` IN('.implode(',', $cates).')) AND secl.`id_lang` = '.(int)Context::getContext()->language->id
        );
